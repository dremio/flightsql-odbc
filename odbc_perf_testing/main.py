...
def start_new_test_process(
    ...
    if test_case_all_lower == 'test-all-sql-types':
        test_all_sql_types.run(
            process_name=test_case,
            create_executable=create_executable,
...
if __name__ == '__main__':
    ...
    parser.add_argument('test_case', help='Which test case to run ["test-fetch-all"|"test-all-types"]')
