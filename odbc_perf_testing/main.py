...
def run(execution_details: ExecutionDetails) -> None:
    ...
    if odbc_library_lower == 'pyodbc':
        start_new_test_process(
            odbc_library_name=odbc_library_lower,
            test_case_name=test_details.test_case,
