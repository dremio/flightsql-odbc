...
def start_new_test_process(
    ...
    if test_case_all_lower == 'test-fetch-all':
        ...
        test_all_sql_types.run_for_all(
            process_name=test_case,
            create_executable=create_executable,
        ...
        raise_for_invalid_value('test_case', "'test-fetch-all', 'test-all-sql-types', 'test-sql-type-*type_name*")
...
if __name__ == '__main__':
    ...
    parser.add_argument('test_case',
                        help='Which test case to run '
                             '["test-fetch-all"|"test-all-sql-types"|"test-sql-type-*type_name*"]')

    # optional
    parser.add_argument('--sql_query', default="", help='The SQL Query to run (only for "test-fetch-all")')
