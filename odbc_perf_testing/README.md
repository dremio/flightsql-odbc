...
```
usage: main.py [-h] [--sql_query SQL_QUERY] [--dsn DSN] [--use_encryption USE_ENCRYPTION] [--library_options LIBRARY_OPTIONS] [--disable_certificate_verification DISABLE_CERTIFICATE_VERIFICATION] [--trust_store TRUST_STORE]
               [--trust_store_password TRUST_STORE_PASSWORD] [--use_system_trust_store USE_SYSTEM_TRUST_STORE] [--token TOKEN]
