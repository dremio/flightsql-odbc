    ...
    def _connect_with_execution_details(execution_details: ExecutionDetails) -> Connection:
        ...
        if not connection_details.dsn:  # Uses custom properties if no DSN is provided for flexibility
            return connect(
                ...
                useSystemTrustStore=int(connection_details.use_system_trust_store),  # bool to int
                disableCertificateVerification=int(connection_details.disable_certificate_verification),  # bool to int
