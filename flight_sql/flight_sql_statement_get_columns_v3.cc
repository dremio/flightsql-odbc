...
Transform_inner(const std::shared_ptr<RecordBatch> &original) {
  ...
  while (reader.Next()) {
    ...
    for (int i = 0; i < schema->num_fields(); ++i) {
      ...
      data.type_name = "";               // TODO
      data.column_size = nullopt;        // TODO
      data.buffer_length = nullopt;      // TODO
      data.decimal_digits = nullopt;     // TODO
      data.num_prec_radix = nullopt;     // TODO
      data.nullable = field->nullable(); // TODO
      data.remarks = nullopt;            // TODO
      data.column_def = nullopt;         // TODO
      data.sql_data_type = 1;            // TODO
      data.sql_datetime_sub = nullopt;   // TODO
      data.char_octet_length = nullopt;  // TODO
      data.ordinal_position = i + 1;     // TODO
      data.is_nullable = nullopt;        // TODO
