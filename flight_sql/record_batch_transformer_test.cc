...
TEST(Transformer, TransformerChangingOrderOfArrayTest) {
  ...
  auto transformer =
      RecordBatchTransformerWithTasksBuilder(schema)
          .RenameField(std::string("third_array"), std::string("test3"))
          .RenameField(std::string("second_array"), std::string("test2"))
          .RenameField(std::string("first_array"), std::string("test1"))
          .AddFieldOfNulls(std::string("empty"), int32())
          .Build();
