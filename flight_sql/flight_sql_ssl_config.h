...
public:
  ...
  arrow::Status readCerts(arrow::flight::CertKeyPair *out);

private:
  bool useEncryption_;
  bool disableCertificateVerification_;
  bool systemTrustStore_;
  std::string trustedCerts_;
};
} // namespace flight_sql
} // namespace driver
