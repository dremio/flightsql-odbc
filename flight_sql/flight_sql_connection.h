...
struct OptionalClientProperties {
...
private:
  OptionalClientProperties optionalClientProperties_;
  ...
  void PopulateOptionalClientPropertiesIfValid(std::pair<std::string, std::string> prop);
