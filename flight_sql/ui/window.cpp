...
std::unique_ptr<Window> Window::CreateTabControl(int id)
{
    ...
    child->Create(WS_CHILD | WS_CLIPSIBLINGS | WS_VISIBLE, 0, 0, rcClient.right, 20, id);
    ...
    int sizeX, int sizeY, int id)
{
    ...
    child->Create(WS_CHILD | WS_VISIBLE | WS_BORDER | LVS_REPORT | LVS_EDITLABELS, posX, posY, sizeX, sizeY, id);
