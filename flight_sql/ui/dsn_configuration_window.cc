...
int DsnConfigurationWindow::CreateEncryptionSettingsGroup(int posX, int posY, int sizeX)
{
    ...
    const bool enableEncryption = !boost::iequals(val, "false") && val != "0";
    ...
    const bool useSystemCertStore = !boost::iequals(val, "false") && val != "0";
    ...
    const bool disableCertVerification = !boost::iequals(val, "false") && val != "0";
