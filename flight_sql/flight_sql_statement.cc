...
FlightSqlStatement::FlightSqlStatement(FlightSqlClient& sql_client, FlightCallOptions call_options) :
  sql_client_(sql_client),
  call_options_(call_options) {
}

void FlightSqlStatement::SetAttribute(StatementAttributeId attribute, const Attribute &value) {
...
FlightSqlStatement::Prepare(const std::string &query) {
  ...
  Result<std::shared_ptr<PreparedStatement>> result = sql_client_.Prepare(call_options_, query);
...
bool FlightSqlStatement::ExecutePrepared() {
  ...
  // TODO: make use of the returned FlightInfo to populate ResultSetMetaData nd ResultSet.
  return true;
}
...
long FlightSqlStatement::GetUpdateCount() {
  return -1;
}

std::shared_ptr<ResultSet>
FlightSqlStatement::GetTables_V2(const std::string *catalog_name, const std::string *schema_name,
...
std::shared_ptr<ResultSet>
FlightSqlStatement::GetTables_V3(const std::string *catalog_name, const std::string *schema_name,
              const std::string *table_name,
              const std::string *table_type) {
  return current_result_;
}
...
std::shared_ptr<ResultSet>
FlightSqlStatement::GetColumns_V2(const std::string *catalog_name, const std::string *schema_name,
              const std::string *table_name,
...
std::shared_ptr<ResultSet>
FlightSqlStatement::GetColumns_V3(const std::string *catalog_name, const std::string *schema_name,
              const std::string *table_name,
              const std::string *column_name) {
  return current_result_;
}
