...
template <>
inline size_t FlightSqlAccessor<Int64Array, C_SBIGINT>::GetColumnarData(
...
template <>
inline void FlightSqlAccessor<Int64Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<UInt64Array, C_UBIGINT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<UInt64Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<Int32Array, C_SLONG>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<Int32Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<UInt32Array, C_ULONG>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<UInt32Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<Int16Array, C_SSHORT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<Int16Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<UInt16Array, C_USHORT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<UInt16Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<Int8Array, C_STINYINT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<Int8Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<UInt8Array, C_UTINYINT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<UInt8Array, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<FloatArray, C_FLOAT>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<FloatArray, C_CHAR>::MoveSingleCell(
...
template <>
inline size_t FlightSqlAccessor<DoubleArray, C_DOUBLE>::GetColumnarData(
    FlightSqlResultSet *result_set, ColumnBinding *binding,
    int64_t starting_row, size_t cells, int64_t value_offset) {
...
template <>
inline void FlightSqlAccessor<DoubleArray, C_CHAR>::MoveSingleCell(
