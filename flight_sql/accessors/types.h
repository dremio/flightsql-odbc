...
struct ColumnBinding {
  ...
  ColumnBinding(int column, DataType target_type, int precision, int scale,
...
public:
  ...
  virtual DataType GetTargetType() = 0;
...
template <typename ARRAY_TYPE, DataType TARGET_TYPE>
inline void MoveSingleCell(ColumnBinding *binding, ARRAY_TYPE *array, int64_t i,
