...
public:
  ...
  virtual size_t GetCellLength(ColumnBinding *binding) = 0;
};
...
public:
  ...
  size_t GetCellLength(ColumnBinding *binding) override {
    return static_cast<DERIVED *>(this)->GetCellLength_impl(binding);
  }
