...
template <>
inline void MoveSingleCell<StringArray, VARCHAR>(ColumnBinding *binding,
...
template <>
inline void MoveSingleCell<StringArray, BIGINT>(ColumnBinding *binding,
                                                StringArray *array, int64_t i,
                                                int64_t value_offset) {
  static_cast<int64_t *>(binding->buffer)[i] = atoll(array->GetView(i).data());
  binding->strlen_buffer[i] = sizeof(int64_t);
}

template <>
inline void MoveSingleCell<StringArray, INTEGER>(ColumnBinding *binding,
                                                 StringArray *array, int64_t i,
                                                 int64_t value_offset) {
  static_cast<int32_t *>(binding->buffer)[i] = atoi(array->Value(i).data());
  binding->strlen_buffer[i] = sizeof(int32_t);
}

template <>
inline void MoveSingleCell<StringArray, SMALLINT>(ColumnBinding *binding,
                                                  StringArray *array, int64_t i,
                                                  int64_t value_offset) {
  static_cast<int16_t *>(binding->buffer)[i] =
      static_cast<int16_t>(atoi(array->Value(i).data()));
  binding->strlen_buffer[i] = sizeof(int16_t);
}

template <>
inline void MoveSingleCell<StringArray, TINYINT>(ColumnBinding *binding,
                                                 StringArray *array, int64_t i,
                                                 int64_t value_offset) {
  static_cast<int8_t *>(binding->buffer)[i] =
      static_cast<int8_t>(atoi(array->Value(i).data()));
