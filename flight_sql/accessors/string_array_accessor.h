...
template <>
inline void MoveSingleCell<StringArray, C_CHAR>(ColumnBinding *binding,
...
template <>
inline void MoveSingleCell<StringArray, C_SBIGINT>(ColumnBinding *binding,
                                                   StringArray *array,
                                                   int64_t i,
                                                   int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_UBIGINT>(ColumnBinding *binding,
                                                   StringArray *array,
                                                   int64_t i,
                                                   int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_SLONG>(ColumnBinding *binding,
                                                 StringArray *array, int64_t i,
                                                 int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_ULONG>(ColumnBinding *binding,
                                                 StringArray *array, int64_t i,
                                                 int64_t value_offset) {
  char *end;
  static_cast<int32_t *>(binding->buffer)[i] =
...
template <>
inline void MoveSingleCell<StringArray, C_SSHORT>(ColumnBinding *binding,
                                                  StringArray *array, int64_t i,
                                                  int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_USHORT>(ColumnBinding *binding,
                                                  StringArray *array, int64_t i,
                                                  int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_STINYINT>(ColumnBinding *binding,
                                                    StringArray *array,
                                                    int64_t i,
                                                    int64_t value_offset) {
  char *end;
...
template <>
inline void MoveSingleCell<StringArray, C_UTINYINT>(ColumnBinding *binding,
                                                    StringArray *array,
                                                    int64_t i,
                                                    int64_t value_offset) {
  char *end;
