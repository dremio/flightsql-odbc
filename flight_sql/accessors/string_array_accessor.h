...
template <>
inline void FlightSqlAccessor<StringArray, C_CHAR>::MoveSingleCell(
...
template <>
inline void FlightSqlAccessor<StringArray, C_SBIGINT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_UBIGINT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_SLONG>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_ULONG>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
  static_cast<int32_t *>(binding->buffer)[i] =
...
template <>
inline void FlightSqlAccessor<StringArray, C_SSHORT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_USHORT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_STINYINT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
...
template <>
inline void FlightSqlAccessor<StringArray, C_UTINYINT>::MoveSingleCell(
    ColumnBinding *binding, StringArray *array, int64_t i,
    int64_t value_offset) {
  char *end;
