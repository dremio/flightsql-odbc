...
#define CASE_FOR_TYPE(TARGET_TYPE)                                             \
  ...
  switch (target_type) {
    CASE_FOR_TYPE(C_CHAR)
    CASE_FOR_TYPE(C_WCHAR)
    CASE_FOR_TYPE(C_SSHORT)
    CASE_FOR_TYPE(C_USHORT)
    CASE_FOR_TYPE(C_SLONG)
    CASE_FOR_TYPE(C_ULONG)
    CASE_FOR_TYPE(C_FLOAT)
    CASE_FOR_TYPE(C_DOUBLE)
    CASE_FOR_TYPE(C_BIT)
    CASE_FOR_TYPE(C_STINYINT)
    CASE_FOR_TYPE(C_UTINYINT)
    CASE_FOR_TYPE(C_SBIGINT)
    CASE_FOR_TYPE(C_UBIGINT)
    CASE_FOR_TYPE(C_BINARY)
  }
#undef CASE_FOR_TYPE
