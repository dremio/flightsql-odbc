...
public:
  explicit RecordBatchTransformerWithTasks(
...
RecordBatchTransformerWithTaskBuilder::RenameRecord(
...
RecordBatchTransformerWithTaskBuilder &
RecordBatchTransformerWithTaskBuilder::AddEmptyFields(
...
RecordBatchTransformerWithTaskBuilder::Build() {
...
RecordBatchTransformerWithTaskBuilder::RecordBatchTransformerWithTaskBuilder(
