...
class RecordBatchTransformerWithTaskBuilder {
private:
...
public:
  ...
  RecordBatchTransformerWithTaskBuilder &
  RenameRecord(const std::string &original_name,
  ...
  RecordBatchTransformerWithTaskBuilder &
  AddEmptyFields(const std::string &field_name,
                 const std::shared_ptr<DataType> &data_type);

  /// It creates an object of RecordBatchTransformerWithTaskBuilder
  /// \return a RecordBatchTransformerWithTaskBuilder object.
  std::shared_ptr<RecordBatchTransformer> Build();

  /// Instantiate a RecordBatchTransformerWithTaskBuilder object.
  /// \param schema   The schema from the original RecordBatch.
  explicit RecordBatchTransformerWithTaskBuilder(
