...
void AssertArraysEqualWith(const arrow::Array& expected, const arrow::Array& actual,
...
void AssertArraysEqual(const arrow::Array& expected, const arrow::Array& actual) {
