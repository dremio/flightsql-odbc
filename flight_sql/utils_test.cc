...
void AssertArraysEqualWith(const arrow::Array& expected, const arrow::Array& actual, bool verbose,
...
void AssertArraysEqual(const arrow::Array& expected, const arrow::Array& actual, bool verbose,
                       const arrow::EqualOptions& options) {
  return AssertArraysEqualWith(
      expected, actual, verbose,
      [&](const arrow::Array& expected, const arrow::Array& actual, std::stringstream* diff) {
