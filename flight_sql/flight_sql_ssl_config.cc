...
bool FlightSqlSslConfig::isUseEncryption() const {
  return useEncryption_;
}

bool FlightSqlSslConfig::isDisableCertificateVerification() const {
...
bool FlightSqlSslConfig::isSystemTrustStore() const {
  return systemTrustStore_;
}

arrow::Status FlightSqlSslConfig::readCerts(arrow::flight::CertKeyPair* out) {
  try {
