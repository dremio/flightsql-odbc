...
{
    Set(Key::DSN, DEFAULT_DSN);
    Set(Key::USE_TLS, DEFAULT_ENABLE_ENCRYPTION);
    Set(Key::USE_CERT_STORE, DEFAULT_USE_CERT_STORE);
    Set(Key::DISABLE_CERT_VERIFICATION, DEFAULT_DISABLE_CERT_VERIFICATION);
}
...
void Configuration::LoadDsn(const std::string& dsn)
{
    ...
    Set(Key::PORT, ReadDsnString(dsn, Key::PORT));
    ...
    Set(Key::USE_TLS, ReadDsnString(dsn, Key::USE_TLS, DEFAULT_ENABLE_ENCRYPTION));
    Set(Key::ENCRYPTION_CERT, ReadDsnString(dsn, Key::ENCRYPTION_CERT));
    Set(Key::USE_CERT_STORE, ReadDsnString(dsn, Key::USE_CERT_STORE, DEFAULT_USE_CERT_STORE));
    Set(Key::DISABLE_CERT_VERIFICATION, ReadDsnString(dsn, Key::DISABLE_CERT_VERIFICATION, DEFAULT_DISABLE_CERT_VERIFICATION));
