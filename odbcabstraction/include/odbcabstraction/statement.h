...
public:
  ...
  /**
   * Set a statement attribute (may be called at any time)
   *
  ...
  /**
   * Execute the statement if it is prepared or not.
   *
  ...
  /**
   * Returns the list of column names in specified tables. The driver returns
  ...
  /**
   * Returns information about data types supported by the data source. The
