...
public:
   ...
   */
  virtual void BindColumn(int column, DataType target_type, void *buffer,
  ...
  /**
   * Returns the value on current row for given column.
   */
  virtual void GetData(int column, DataType target_type, void *buffer,
