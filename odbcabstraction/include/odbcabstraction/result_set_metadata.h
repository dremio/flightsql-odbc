...
class ResultSetMetadata {
  ...
  virtual bool IsNullable(int column_position) = 0;
  ...
  virtual size_t GetUpdatable(int column_position) = 0;
  ...
  virtual bool IsAutoIncremental(int column_position) = 0;
